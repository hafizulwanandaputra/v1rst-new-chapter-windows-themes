...
OutputBaseFilename=v1rstnewchapterthemes-{#MyAppVersion}-winnt4.0
Compression=lzma2/ultra64
LZMAUseSeparateProcess=yes
LZMADictionarySize=262144
LZMANumFastBytes=273
MinVersion=0,4.0.1273
...
VersionInfoDescription={#MyAppName} for Windows NT 4.0
...
[Files]
Source: "..\Theme Files\Windows NT 4.0\*"; DestDir: "{app}"; Components: base; Flags: ignoreversion recursesubdirs createallsubdirs
...
[Run]
Filename: "{pf}\Plus!\Themes\Themes.exe"; Description: "Open Desktop Themes"; Flags: nowait postinstall shellexec skipifsilent
...
begin
  if RegKeyExists(HKEY_LOCAL_MACHINE,
    ...
    if not result then
      MsgBox('Desktop Themes is not installed, you must install Desktop Themes from Windows NT 4.0 Resource Kit CD-ROM!', mbCriticalError, MB_OK);
  end;
end.