...
OutputBaseFilename=v1rstnewchapterthemes-{#MyAppVersion}-win98
Compression=lzma2/ultra64
LZMAUseSeparateProcess=yes
LZMADictionarySize=262144
LZMANumFastBytes=273
MinVersion=4.10,0
OnlyBelowVersion=4.90,0
...
VersionInfoDescription={#MyAppName} for Windows 98
...
[Files]
Source: "..\Theme Files\Windows 98\*"; DestDir: "{app}"; Components: base; Flags: ignoreversion recursesubdirs createallsubdirs
