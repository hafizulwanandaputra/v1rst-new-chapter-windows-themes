...
OutputBaseFilename=v1rstnewchapterthemes-{#MyAppVersion}-winxp
Compression=lzma2/ultra64
LZMAUseSeparateProcess=yes
LZMADictionarySize=262144
LZMANumFastBytes=273
MinVersion=0,5.1.2465
OnlyBelowVersion=0,6.0.5259
...
VersionInfoDescription={#MyAppName} for Windows XP
...
Name: "luna"; Description: {cm:T_Luna}
Name: "custom"; Description: {cm:T_Custom}; Flags: iscustom

[Components]
Name: "base"; Description: "Base Theme"; Types: full base luna custom; Flags: fixed
Name: "wallpaper"; Description: "Additional Wallpapers Sizes"; Types: full custom
Name: "luna"; Description: "Luna - Silver (5.1.2481-6.0.5059)"; Types: full luna custom

[Files]
Source: "..\Theme Files\Windows XP\*"; DestDir: "{app}\Resources\Themes"; Components: base; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\Theme Files\Windows XP Luna\*"; DestDir: "{app}\Resources\Themes"; Components: luna; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\Theme Files\Windows XP Readme\V1RST New Chapter Themes Readme.txt"; DestDir: "{app}"; Components: base; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\Wallpaper\*"; DestDir: "{app}\Web\Wallpaper"; Components: base; Flags:
...
T_Luna=Base Theme Only + Luna (Silver)
TD_Luna=Installs base theme only + Luna (Silver) variant
T_Custom=Custom
