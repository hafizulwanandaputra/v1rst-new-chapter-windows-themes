...
OutputBaseFilename=v1rstnewchapterthemes-{#MyAppVersion}-whistler
Compression=lzma2/ultra64
LZMAUseSeparateProcess=yes
LZMADictionarySize=262144
LZMANumFastBytes=273
MinVersion=0,5.1.2242
OnlyBelowVersion=0,5.1.2465
...
VersionInfoDescription={#MyAppName} for Windows Whistler (2242-2464)
...
[Files]
Source: "..\Theme Files\Windows XP\*"; DestDir: "{app}\Resources\0409\Themes"; Components: base; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\Theme Files\Windows Whistler\V1RST New Chapter Themes Readme.txt"; DestDir: "{app}"; Components: base; Flags: ignoreversion recursesubdirs createallsubdirs
